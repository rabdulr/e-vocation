...
const JobSearch = ({ result, searchReturn, setFocus, submitSearch, searchTerms, updateTerms, setSearchTerms, setSearchReturn }) => {
    ...
    return (
        <div>
            <form onSubmit = { submitSearch } className = 'rowNW margin1'>
