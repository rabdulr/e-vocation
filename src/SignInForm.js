        ...
        <div className = 'columnNW alignCenter z2 widthundred heighthundred bgAlphaDB frosted'>
            ...
            <form className = 'columnNW borderAO bgBB colorOW pad1 margin1 border5 maxWidth3 scrollable maxHeight3' onSubmit={ onSubmit }>
                ...
                <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>First Name: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'First Name...' pattern = '.{1,}' value = { firstname } onChange = { ({ target }) => setFirstname(target.value) } />
                </div>
                <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>lastName: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'Last Name...' pattern = '.{1,}' value = { lastName } onChange = { ({ target }) => setlastName(target.value) } />
                </div>
                <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>Address: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'Primary Address...' pattern = '.{1,}' value = { address } onChange = { ({ target }) => setAddress(target.value) } />
                </div>
                <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>City: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'City...' pattern = '.{1,}' value = { city } onChange = { ({ target }) => setCity(target.value) } />
                </div>
                <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>State: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'State Abreviation...' pattern = '.{2,2}' value = { state } onChange = { ({ target }) => setState(target.value) } />
                </div>
                <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>Zip Code: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'Zip Code...' pattern = '.{5,6}' value = { zip } onChange = { ({ target }) => setZip(target.value) } />
                </div>
                { isCompany && <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>Company: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'New Company...' pattern = '.{1,}' value = { companyName } onChange = { ({ target }) => setcompanyName(target.value) } />
                </div> }
                { isCompany && <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>Industry: </div>
                    <input className = 'bgLB colorDB borderDB padQuarter' placeholder = 'Primary Industry...' pattern = '.{1,}' value = { industry } onChange = { ({ target }) => setIndustry(target.value) } />
                </div> }
                <div className = 'rowNW spaceBetweenRow topMargin1 widthundred'>
                    <div>Username: </div>
